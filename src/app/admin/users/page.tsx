    ...
    <>
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm">
          Volunteers and sign-ups from Join Us. Same Supabase DB. Total: {volunteers.length}
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-gray-700/50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Course / Batch</th>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {volunteers.map((v) => (
                <tr key={v.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{formatDate(v.created_at)}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        {volunteers.length === 0 && (
          <div className="text-center py-12 text-gray-500 dark:text-gray-400">No users yet.</div>
        )}
      </div>
    </>
  );
